...
student architecture/training, validation windows, and mocked Docker/Modal/Prime
trainer lifecycles.
...
2. Implement it in `DocumentFilter._apply_one` in `corpus.py`.
...
- loader defaults match the configuration table and full-reference TOML;

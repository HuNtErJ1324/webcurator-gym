...
def score_components(train_call, decon_call):
    ...
    try:
        ...
        # Python 3.8 has no ``cancel_futures`` argument. Worker functions have
        # bounded subprocess timeouts, and the exception path above terminates
        # their active children before waiting for thread teardown.

...
from pretrain_curation_gym.util.container_memory import (
...
def test_verify_runtime_memory_limit_uses_inspect(monkeypatch):
    ...
    monkeypatch.setattr(
        "pretrain_curation_gym.util.container_memory.inspect_container_memory",
        fake_inspect,
    )
...
def _load_self_score_helpers():
    ...
    from pretrain_curation_gym.gpu import self_score as mod
...
async def test_heuristic_docker_setup_skips_memory_pin(monkeypatch):
    ...
    monkeypatch.setattr(
        "pretrain_curation_gym.util.container_memory.verify_runtime_memory_limit",
        boom,
    )

...
def test_prompt_preserves_existing_guidance():
    ...
    assert ".agents/skills/hf-cli/SKILL.md" in prompt
...
def _eval_wrapper_repo(
    ...
    *,
    ...
    env_dir = repo / "environments" / "pretrain_curation_gym"
...
def test_validation_uses_this_runs_logged_dir_not_a_repo_scan(tmp_path: Path):
    ...
    stale = repo / "environments" / "pretrain_curation_gym" / "outputs" / "old-good"
